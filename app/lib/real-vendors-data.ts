...
export const REAL_VENDORS_DATABASE: { [key: string]: RealVendorData[] } = {
  ...
  catering: [
    {
      ...
      verified: true,
      specialties: ['Fine dining', 'British cuisine', 'Luxury events'],
      availability: true,
      responseTime: 'Within 24 hours',
      languages: ['English', 'French'],
      isReal: true
  ...
  florist: [
    ...
    },
    {
      ...
      category: 'florist',
      description: 'Creative florist known for natural, organic arrangements and unique wedding designs using seasonal British flowers.',
      location: 'London',
      ...
      features: ['Natural style', 'Seasonal flowers', 'Organic designs', 'British grown flowers', 'Sustainable practice', 'Bespoke consultation'],
      businessHours: {
      ...
      verified: true,
      specialties: ['Natural arrangements', 'Seasonal flowers', 'British grown'],
      availability: true,
      responseTime: 'Within 6 hours',
      languages: ['English'],
      isReal: true
